 ...
 */
class CRM_Extracdntaxreceipts_Upgrader_Base {

  /**
   * @var CRM_Extracdntaxreceipts_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Extracdntaxreceipts_Upgrader(
        'extracdntaxreceipts',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Extracdntaxreceipts_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Extracdntaxreceipts_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
